...
bandit_posterior(data=data.frame(machine = c(1), outcome = c("W"))) %>%
  bandit_posterior(data=data.frame(machine = c(1), outcome = c("W")), prior = .) %>%
  bandit_posterior(data=data.frame(machine = c(2), outcome = c("W")), prior = .) %>%
  bandit_posterior(data=data.frame(machine = c(2), outcome = c("W")), prior = .) %>%
  bandit_posterior(data=data.frame(machine = c(2), outcome = c("L")), prior = .)
```
...
bandit_posterior(data=data.frame(machine = c(2), outcome = c("W"))) %>%
  bandit_posterior(data=data.frame(machine = c(2), outcome = c("W")), prior = .) %>%
  bandit_posterior(data=data.frame(machine = c(2), outcome = c("L")), prior = .) %>%
  bandit_posterior(data=data.frame(machine = c(1), outcome = c("W")), prior = .) %>%
  bandit_posterior(data=data.frame(machine = c(1), outcome = c("W")), prior = .)
